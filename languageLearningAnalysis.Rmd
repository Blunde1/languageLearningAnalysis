...
```{r parallel-cooredinate-plot, fig.cap="Observasjoner av målinger i Tabell 1 til 8. Observasjonane er standardiserte for å oppnå ein felles skala. Forsøkspersonene med manglende observasjon i Tabell 1 er gruppert i oransj."}
p <- 
  ggparcoord(
    llData,
    columns = 2:9, groupColumn = 10, missing="mean",
    showPoints = TRUE, 
...
dataLong %>%
  ...
  scale_colour_manual(values=cbp) + 
  theme(legend.position = "top") + 
  ggtitle("Parallel Coordinate Plot for Measurements")
```
